...
db.addresses.aggregate([{$project:{restaurant_id:1,name:1,borough:1,zipcode:1,_id:0}}])
...
db.addresses.find({borough:{$nin:['Staten Island','Queens','Bronxor Brooklyn']}},{restaurant_id:1,name:1,borough:1,cuisine:1})
...
db.addresses.find({$or:[{cuisine:{$nin:['American','Chinese']}},{name:/^wil/}]})
...
db.addresses.aggregate([{$group:{_id:{cuisine:'$cuisine',borough:'$borough'}}},{$sort:{cuisine:1,borough:-1}}])
...
db.addresses.find({name:{$regex:'mon'}},name:1,borough:1,'address.coord':1,cuisine:1)
